...
## Nouvelle vague d’unification (PR #29, #30, #32, #33, #34, #35, #35, #37, #38, #39, #40, #41, #42, #43, #44)
- Objectif : regrouper toutes les PR listées ci-dessus en un seul merge propre sur `main` sans doublons (deux entrées #35 à vérifier).
- Étapes proposées :
...
- Notes rapides :
  - Traiter le doublon #35 pour éviter une inclusion multiple.
